...
/*
	const ledgerProofLength = 3 + 65 + (proofBuffer.readUInt8(3+65+1) +2) + 32; 	
	const sig1len = proofBuffer.readUint8(ledgerProofLength+(32+8+1+32)+1)+2; 
	const appKey1 = proofBuffer.slice(3, 3 + 65);
	const sig2offset = ledgerProofLength + 32 + (8+1+32) + sig1len + 65;
	const sig2len = proofBuffer.readUint8(sig2offset+1) + 2;
*/
